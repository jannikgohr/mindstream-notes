...
export enum TauriCommandName {
  ...
  PluginsStorageDelete = 'plugins_storage_delete',
  PluginsStorageList = 'plugins_storage_list',
  PluginsStorageReadText = 'plugins_storage_read_text',
  PluginsStorageWriteText = 'plugins_storage_write_text',
