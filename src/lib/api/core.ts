...
export enum TauriCommandName {
  ...
  ConvertLegacyWikilinks = 'convert_legacy_wikilinks_command',
  CreateNote = 'create_note',
  CreateProfile = 'create_profile',
  CustomDictionaryAdd = 'custom_dictionary_add',
  CustomDictionaryList = 'custom_dictionary_list',
  CustomDictionaryRemove = 'custom_dictionary_remove',
  ...
  TextCheckerCheck = 'text_checker_check',
  TextCheckerTestConnection = 'text_checker_test_connection',
  ...
  LegacyWikilinkCount = 'legacy_wikilink_count',
  ...
  NotesImportCancel = 'notes_import_cancel',
  NotesImportDetect = 'notes_import_detect',
  NotesImportPickFile = 'notes_import_pick_file',
  NotesImportPickFolder = 'notes_import_pick_folder',
  NotesImportRun = 'notes_import_run',
  OpenDataFolder = 'open_data_folder',
  OpenFolder = 'open_folder',
  PdfNoteNeedsText = 'pdf_note_needs_text',
  PdfNotesMissingText = 'pdf_notes_missing_text',
  PluginsApprove = 'plugins_approve',
  PluginsArtifactsStatus = 'plugins_artifacts_status',
  PluginsDisable = 'plugins_disable',
  PluginsDiscover = 'plugins_discover',
  PluginsDownloadArtifact = 'plugins_download_artifact',
  PluginsEnable = 'plugins_enable',
  PluginsGet = 'plugins_get',
  PluginsList = 'plugins_list',
  PluginsNativeServiceStatus = 'plugins_native_service_status',
  PluginsNativeToolStatus = 'plugins_native_tool_status',
  PluginsPreviewStart = 'plugins_preview_start',
  PluginsPreviewStop = 'plugins_preview_stop',
  PluginsPreviewUpdate = 'plugins_preview_update',
  PluginsRemove = 'plugins_remove',
  PluginsReadArtifact = 'plugins_read_artifact',
  PluginsReadFile = 'plugins_read_file',
  PluginsRunNativeTool = 'plugins_run_native_tool',
  PluginsRunScript = 'plugins_run_script',
  PluginsSetLoadError = 'plugins_set_load_error',
  PluginsSettingsAll = 'plugins_settings_all',
  PluginsSettingsRemove = 'plugins_settings_remove',
  PluginsSettingsSet = 'plugins_settings_set',
  ...
  SpellcheckAvailableDictionaries = 'spellcheck_available_dictionaries',
  SpellcheckInstallDictionary = 'spellcheck_install_dictionary',
  SpellcheckInstalledDictionaries = 'spellcheck_installed_dictionaries',
  ...
  SpellcheckReleaseDictionaries = 'spellcheck_release_dictionaries',
